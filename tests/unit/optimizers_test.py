...
_QWEN3_NEXT_GDN_ATTENTION = {
    "A_log": mdn(reduction_axis=(0,), output_axis=(-1,)),
...
_GPT_OSS_ATTENTION = {
    "query": {"kernel": mdn(reduction_axis=(0,), output_axis=(-1,)), "bias": None},
    "key": {"kernel": mdn(reduction_axis=(0,), output_axis=(-1,)), "bias": None},
    "value": {"kernel": mdn(reduction_axis=(0,), output_axis=(-1,)), "bias": None},
    "out": {"kernel": mdn(reduction_axis=(0,), output_axis=(-1,)), "bias": None},
    "sinks": None,
}
